...
import 'package:example/src/miniplayer_will_pop_scope.dart';
import 'package:example/src/utils.dart';

export 'package:example/src/miniplayer_will_pop_scope.dart';
                    ...
                    child: ValueListenableBuilder(
                      ...
                      child: Material(
                        ...
                        child: Container(
                          ...
                          child: globals.mini==true? widget.builder(value, _percentage): Container(color: Colors.red,child:Text("here")),
